...
class Departamento(models.Model):
    ...
    extension = models.DecimalField("Extensión Territorial", max_digits=10,decimal_places=2, null=True)
...
class Municipio(models.Model):
    ...
    nombre = models.CharField(max_length=30, unique=True)
    slug = models.SlugField(unique=True, null=True, help_text="Usado como url única(autorellenado)")
    extension = models.DecimalField("Extensión Territorial", max_digits=10, decimal_places=2, blank=True, null=True)
